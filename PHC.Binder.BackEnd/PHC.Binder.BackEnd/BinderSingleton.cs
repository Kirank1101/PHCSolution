namespace PHC.Binder.BackEnd
{
    ...
    /// <li>PHC.CaseConverter.BackEnd.ICaseConverter</li>
    /// <li>PHC.Mediator.BackEnd.ICaseConverterMediator</li>
    /// <li>PHC.Mediator.BackEnd.IICAInterfaceMediator</li>
    /// <li>PHC.Mediator.BackEnd.ITasklistMediator</li>
    /// <li>PHC.Mediator.BackEnd.IFilingBrokerMediator</li>
    /// <li>PHC.Mediator.BackEnd.IWorkflowEngineMediator</li>
    /// <li>PHC.Mediator.BackEnd.IDataSyncMediator</li>
    /// <li>PHC.Tasklist.BackEnd.ITasklist</li>
    /// <li>PHC.FilingBroker.BackEnd.IFilingBrokerBackEnd</li>
    /// <li>PHC.ExternalInterface.BackEnd.IIcaInterface</li>
    /// <li>PHC.WorkFlowEngine.BackEnd.IWorkFlowEngine</li>
    /// <li>PHC.DataSync.BackEnd.IDataSyncBackEnd</li>
    /// <li>PHC.AppMon.IAppMon</li>
    /// </ol>
    /// <br/>
