   ...
   public  interface ITransactionBusiness
    {
       ...
       // ResultDTO AddPatientInfo(string patientName, string age, string sex, string dob, string bloodgroup,string PHCID,string contactno);
        ...
        ResultDTO SavePatientDetails(string PHCID, string PatientName, string ECNumber, short Age, string DOB, string Gender, string BloodGroup, string VillageID, string Address, string ContactNo, string PhoneNo, string EducationID, string ReligionID,string MarritalStatus,string FatherName,string HusbandName);
        ResultDTO UpdatePatientDetail(string PHCID, string PatientID, string PatientName, string ECNumber, short Age, string DOB, string Gender, string BloodGroup, string VillageID, string Address, string ContactNo, string PhoneNo, string EducationID, string ReligionID, string MarritalStatus, string FatherName, string HusbandName);
